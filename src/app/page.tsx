    ...
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-green-100">
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Second Row - Video Upload */}
          <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {/* Video Upload Card */}
            <Link href="/video-upload" className="group">
              <div className="bg-white/30 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105 border border-white/20">
                <div className="text-center">
                  <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 bg-gradient-to-br from-red-100 to-pink-100 rounded-xl flex items-center justify-center group-hover:from-red-200 group-hover:to-pink-200 transition-colors">
                    <span className="text-2xl md:text-3xl">🎥</span>
                  </div>
                  <h2 className="text-sm md:text-lg font-bold text-gray-900">영상 업로드</h2>
                </div>
              </div>
            </Link>
